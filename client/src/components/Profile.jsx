...
export default function Profile({ type }) {
    ...
    useEffect(() => {
        tokenExists(token, navigate, dispatch).then(data => 
            (data == false || JSON.parse(localStorage.getItem('userInfo'))._id !== id || window.location.href.slice(32).split('/')[0] !== JSON.parse(localStorage.getItem('userInfo')).role) && navigate("/login")
        );
    ...
    const handleSave = () => {
        ...
        // Validation for full name, age, and username
        ...
        <>
            ...
            <div className='Profile'>
                <div className="container">
                        ...
                        <form encType="multipart/form-data" onSubmit={e => e.preventDefault()}>
                            <div className="profileHeader">
                                ...
                                <div className="profileheaderbuttons">
                                    <button onClick={e => window.location.href = `/dashboard/${type === "1" ? "company" : "client"}/${id}/profile`}>Cancel</button>
                    ...
                    {type === "1" ? <CompanyMenu active="profile" /> : <ClientMenu active="profile" />}
                </div>
            </div>
        </>
    );
