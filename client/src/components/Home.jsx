        ...
        <div className='Home'>
            <div className="container">
                <main id='#'>
                    <div className="description" data-aos='fade-up' data-aos-delay="350" >
                        <div className='hero-description'>Top Services At Your Fingertips</div>
                        <p>Whether you're a business looking for support or a company looking for work, we've got you covered</p>
            ...
            <footer>
                ...
                <p className="footer-body">
                    Paysys Services is a leading provider of IT related services, connecting service providing companies with clients who need their skills and expertise. From website design and development to auditing and management portals, our team has the knowledge and experience to help you succeed.
                </p>
                <div className="footer-footer">
                    <div className="copyright">
                        Copyright Paysys Services ©2025 | All Rights Reserved
                    </div>
