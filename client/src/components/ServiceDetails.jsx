...
import { showService } from '../Redux/CompanySlice';
...
export default function ServiceDetails({ type }) {
    ...
    const { data } = useSelector(type == 1 ? (state => state.company) : (state => state.client))
                                        ...
                                        <>
                                            ...
                                            {type == 1 ?
                                                <div className="service-price">
                                                    Contact: {data.selectedService.price} 
                                                </div>
                                                :
