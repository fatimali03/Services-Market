...
import { createService } from "../../Redux/CompanySlice";
...
export default function CompanyCreateService() {
                ...
                dispatch(createService(body)).unwrap().then(data => {
                    setTimeout(() => {
                        ...
                        if (data.status == 200) {
                            ...
                            navigate(`/dashboard/company/${id}/services`)
    ...
    return (
        <>
            {loading && <Loading />}
            <div className="CompanyCreateService">
                    ...
                    <div className="section">
                        ...
                        <form encType="multipart/form-data" onSubmit={e => handleSubmit(e)}>
                            ...
                            <div className="form-section">
                                ...
                                <input type="text" name="price" ref={price} placeholder="Enter Contact Number (Use +92 format)" id="price" />
                            </div>
                            <div className="form-section">
