...
import { myDashboard } from '../../Redux/CompanySlice';  
...
export default function CompanyDashboard() {
    ...
    const { data } = useSelector(state => state.company); // Change to `chat` for company dashboard data
    const { id } = useParams();
    ...
    useEffect(() => {
        tokenExists(token, navigate, dispatch).then(data => 
            (data === false || JSON.parse(localStorage.getItem('userInfo')).role !== "company" || JSON.parse(localStorage.getItem('userInfo'))._id !== id) && navigate("/login")
        );

        // Fetching dashboard data dynamically for company
        ...
        <>
            ...
            <div className="CompanyDashboard">
                <div className="container">
                            ...
                            <>
                                ...
                                <div className="stats">
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="logo">
                                            <img src={check} alt="Completed icon" />
                                        </div>
                                    </div>
                                    <div className="card">
                                        <div className="info">
                                ...
                                <div className="testimonials">
                                    ...
                                    <div className="cards">
                                        {data?.dashboard?.testimonials.length !== 0 ? (
                                            <TestimonialSlider role="company" data={data?.dashboard?.testimonials} />
                                        ) : (
                    ...
                    <CompanyMenu active="home" userRole="company" />
                </div>
            </div>
        </>
    );
