        ...
        <div className="container">
          <div className="section">
            <div className="buttons">
              <HashLink to={`/dashboard/company/${id}/services/create`}><button>Create Service</button></HashLink>
              <HashLink to={`/dashboard/company/${id}/services/manage`}><button>Manage Services</button></HashLink>
            </div>
              ...
              {data?.allServices && data.allServices.length != 0 ? data.allServices.map(service => <div key={service._id} className="service">
                ...
                <div className="serviceBody">
                  ...
                  <div className="rating-more">
                    ...
                    <HashLink to={`/dashboard/company/${id}/services/show/${service._id}`}> <button>See More</button></HashLink>
                  </div>
                </div>
                <hr />
